# Generated by Django 3.1.7 on 2021-06-19 08:38
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='missatge',
            name='autor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='autormissatge', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='missatge',
            name='destinatari',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='destmissatge', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='llibre',
            name='dissenyador',
