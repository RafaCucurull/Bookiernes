    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('traduccio', models.FileField(upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mkd_traduit', models.FileField(blank=True, null=True, upload_to='')),
                ('idioma', models.CharField(blank=True, max_length=30, null=True)),
